...
const CustomFormInput = ({
  ...
  let defaultStyle = `form-control ${suffixText && "border-left-0"} ${!isShowAppearance && "_text_field"
    }`;
    ...
    <Fragment>
      <div>
        <div>
          ...
          {length && (
            <span
              className={`float-left ${isValueLengthBigherThanLength ? "text-danger" : null
                }`}
