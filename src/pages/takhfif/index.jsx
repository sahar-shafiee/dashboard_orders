...
import CustomFormikForm from "../../utils/Custom/CustomFormikForm/CustomFormikForm";
import CustomSelectList from "../../utils/Custom/CustomSelectList/CustomSelectList";
import CustomFormikButton from "../../utils/Custom/CustomFormikButton/CustomFormikButton";
import CustomSwitchButton from "../../utils/Custom/CustomSwitchButton/CustomSwitchButton";
import CustomDivNote from "../../utils/Custom/CustomDivNote/CustomDivNote";
      ...
      <div className="content-background ">
        <div className="main-container">
          <div className="right-menu">
            <div className="side-menu-containe"></div>
          </div>
          {/* main partt */}
          <div className="content">
            <div className="row">
              <div className="ios-header w-100"></div>
              <CustomFormikForm
